module ApplicationHelper
  ...
  def category_link(category, *seller_id)
    link_to category.name.capitalize, items_path(category_id: category.id, seller_id: seller_id.first.to_i), class:"list-group-item #{params[:category_id].to_i == category.id ? 'active' : ''}"
  end
end
